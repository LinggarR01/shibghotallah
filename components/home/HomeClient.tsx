    ...
    <motion.div
      ...
      <motion.section
        ...
        <motion.div
          ...
          className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce flex-col items-center hidden sm:flex">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16 md:mb-24">
            ...
            <motion.div variants={fadeInUp} className="order-2 lg:order-1">
              ...
              <motion.button
                ...
                className="text-emerald-700 font-bold hover:text-emerald-500 transition-colors flex items-center group text-sm md:text-base">
