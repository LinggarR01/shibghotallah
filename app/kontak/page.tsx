...
export default function KontakPage() {
  return (
    <div className="min-h-screen bg-gray-50 w-full flex flex-col font-quicksand">
      {/* Header Section (Opsional: Jika kamu masih memakai header hijau sebelumnya, letakkan di atas sini) */}

      {/* Main Content Section */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-20">
        {/* Layout diubah menjadi max-w-3xl dan diposisikan di tengah (mx-auto) */}
        <div className="max-w-3xl mx-auto">
          {/* Card Informasi Kontak */}
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 border-b-2 border-emerald-100 pb-4 text-center">
              Informasi Kontak
            </h2>
